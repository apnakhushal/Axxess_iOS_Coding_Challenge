...
class ButtonViewController: UIViewController {
    ...
    func configUI() -> Void {
        ...
        allButton.titleLabel?.font = UIFont(name: "Noteworthy-Light", size: 54.0)
        ...
        textOnlyButton.titleLabel?.font = UIFont(name: "Noteworthy-Light", size: 54.0)
        ...
        imagesOnlyButton.titleLabel?.font = UIFont(name: "Noteworthy-Light", size: 54.0)
    ...
    // MARK: Actions
    @objc func dismissNavControllerAction() -> Void {
